...
proc create_root_design { parentCell } {
  ...
  # Create instance: DA4_GPIO, and set properties
  set DA4_GPIO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DA4_GPIO ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins DA4_GPIO/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  ...
  assign_bd_address -offset 0x41260000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DA4_GPIO/S_AXI/Reg] -force
