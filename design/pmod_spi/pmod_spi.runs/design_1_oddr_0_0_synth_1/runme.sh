...
HD_PWD='C:/Zedboard_Projects/ZedboardMemristorControl/design/pmod_spi/pmod_spi.runs/design_1_oddr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_oddr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_oddr_0_0.tcl
